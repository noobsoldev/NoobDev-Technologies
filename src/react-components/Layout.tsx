          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'About', 'Services', 'Showcase', 'Blog', 'Startup Perks', '100 Business Initiative', 'Contact'].map((item) => (
                <li key={item}>
                  <a href={item === 'Home' ? '/' : item === 'Startup Perks' ? '/perks' : item === '100 Business Initiative' ? '/100-business-initiative' : `/${item.toLowerCase().replace(' ', '')}`} className="text-gray-700 hover:text-[#FF0000] text-sm transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['AI Automation', 'Web Development', 'SEO & GEO Services', 'CRM Solutions'].map((item) => (
                <li key={item}>
                  <a href="/services" className="text-gray-700 hover:text-[#FF0000] text-sm transition-colors">
                    {item}
                  </a>
                </li>
              ))}
